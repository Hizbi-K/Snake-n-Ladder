        ...
        switch(gmode)
        {
            case 1://For Singleplayer.
                ...
                while((inipose1 < 36) && (aipose < 36))
                {
                    ...
                    if (inipose1 + dice1 < 37)
                        ...
                        printf("\nYour position %d is greater than max position.\n", inipose1 + dice1);
            ...
            case 2://For Multiplayer.
                while((inipose1 < 36) && (inipose2 < 36))
                {
                    ...
                    dice1 = 1 + rand() / (RAND_MAX / (6 - 1 + 1) + 1);//Random number generator for rolling the dice.
                    printf("The dice for player 1 rolled as %d\n", dice1);

                    if (inipose1 + dice1 < 37)
                        {inipose1 = inipose1 + dice1;
                        printf("The player 1 is at position %d\n", inipose1);}
                    else
                        printf("\nThe player 1's position %d is greater than max position.\n", inipose1 + dice1);
